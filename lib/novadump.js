    ...
    return function (session, data) {
      ...
      if (detected === void 0) {
        ...
        if (sendBuf.readableBytes() >= msgSize) {
          ...
          var _thrift$decode = thrift.decode(thriftBuffer),
              type = _thrift$decode.type,
              name = _thrift$decode.name,
              id = _thrift$decode.id,
              fields = _thrift$decode.fields;
    ...
    return function (session, data) {
      ...
      if (detected === void 0) {
        ...
        if (recvBuf.readableBytes() >= msgSize) {
          ...
          var _thrift$decode2 = thrift.decode(thriftBuffer),
              type = _thrift$decode2.type,
              name = _thrift$decode2.name,
              id = _thrift$decode2.id,
              fields = _thrift$decode2.fields;
